...
module.exports = {
    ...
    //database:'mongodb://cvss:StrongLongPass@127.0.0.1:27017/cvss',
   ...
   //reviewToken: 'randomtoken',
    ...
    serverHost: process.env.CVSS_HOST || '127.0.0.1',
    serverPort: process.env.CVSS_PORT || 3555,
    basedir: '/',
    ...
    // Keep these safe and secured and readable only by account running cvss process!
